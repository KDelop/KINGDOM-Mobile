class StaticController < ApplicationController
  ...
  skip_before_action :check_user_subscription, only: [:confirm_phone, :after_sign_up, :verify_otp, :generate_report]
